...
void defos_init()
{
    ...
    EM_ASM({
        ...
        document.addEventListener('mousemove', Module.__defosjs_mousemove_listener); }, DEFOS_EVENT_MOUSE_ENTER, DEFOS_EVENT_MOUSE_LEAVE, DEFOS_EVENT_CLICK, DEFOS_EVENT_INTERACTION);
...
void defos_set_window_icon(const char* icon_path)
{
    EM_ASM({
        ...
        changeFavicon(UTF8ToString($0)); }, icon_path);
}
